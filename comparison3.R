...
dim(dfvcf)
#2,490,062  4
dfhaplominer <-read.table("NA12878_hifi_haplomaker.hap", colClasses=c("character", "numeric","character","character","character","character") ,header=F, fill=T)
